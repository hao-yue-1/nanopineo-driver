...
{
	/* 申请设备号 */
	alloc_chrdev_region(&hello.devid, 0, 1, "hello");	// 向内核申请设备号
	hello.major = MAJOR(hello.devid);	// 获取主设备号
	hello.minor = MINOR(hello.devid);	// 获取次设备号
...
{
	cdev_del(&hello.cdev);	// 删除字符设备 cdev
